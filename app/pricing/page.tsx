  ...
  return (
    <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '3rem 2rem' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <ul style={{
            ...
            {[
              ...
              <li key={i} style={{ padding: '0.5rem 0', color: '#4a5568' }}>
                ✓ {feature}
              </li>
            ))}
          </ul>
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '1rem' }}>
            <div style={{ fontSize: '1.5rem', color: '#718096', textDecoration: 'line-through' }}>
              $149
            </div>
      ...
      <section style={{ marginTop: '4rem', maxWidth: '800px', margin: '4rem auto 0' }}>
        <h2 style={{ textAlign: 'center', fontSize: '2rem', marginBottom: '2rem', color: '#1a365d' }}>
          Frequently Asked Questions
        </h2>
        {[
          {
            q: 'Is this legally valid in Louisiana?',
            a: 'Yes! Our templates follow Louisiana state requirements and formatting guidelines.'
          },
          {
            q: 'Do I need a lawyer?',
            a: 'While we provide templates and guidance, complex cases may benefit from legal review. Our Premium plan includes a consultation.'
          },
          {
            q: 'What payment methods do you accept?',
            a: 'We accept all major credit cards and debit cards via secure Stripe payment processing.'
          },
          {
